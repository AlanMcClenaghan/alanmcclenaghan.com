...
function addInventory(product, quantityAdded) {
    product.inventory += quantityAdded;
    console.log(quantityAdded + " " + product.name + "(s) added to the inventory");
    console.log(product.inventory + " " + product.name + "(s) now in stock");
}    
...
function processSale(prod, quantitySold) {
    prod.inventory -= quantitySold;
    console.log(quantitySold + " " + prod.name + "(s) sold");
    console.log(prod.inventory + " " + prod.name + "(s) now in stock");
    return product.unit_price * quantitySold;
}
