...
const fullname = forename.toUpperCase() + " " + surname.toUpperCase();
...
alert("The string '" + fullname + "' is " + lengthOfName + " characters long.");