//HOURLY TRAFFIC line chart function
function hourly() {
...
//DAILY TRAFFIC line chart function
function daily() {
  var ctx = document.getElementById("line-chart");
  console.log(ctx);
  var lineChart = new Chart(ctx, {
...
//WEEKLY TRAFFIC line chart function
function weekly() {
  var ctx = document.getElementById("line-chart");
  var lineChart = new Chart(ctx, {
      type: 'line',
...
//MONTHLY TRAFFIC line chart function
function monthly() {
  var ctx = document.getElementById("line-chart");
  console.log(ctx);
  var lineChart = new Chart(ctx, {
...
//Call for WEEKLY TRAFFIC line chart function to match mockup start position
weekly();
