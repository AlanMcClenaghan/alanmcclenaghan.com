...
const number1 = parseFloat(prompt("Give me a number"));
console.log(number1);

// 5. Repeat steps 3 and 4 to create a second variable and collect a second number
const number2 = parseFloat(prompt("Give me another number"));
console.log(number2);
...
//    "3 / 4 = 0.75"
//    "3 - 4 = -1"
message += number1 + " x " + number2 + " = " + (number1 * number2) + "<br>";
message += number1 + " / " + number2 + " = " + (number1 / number2) + "<br>";
message += number1 + " - " + number2 + " = " + (number1 - number2) + "<br>";
